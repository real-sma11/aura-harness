...
//!
//! Codex-derived editing constraints: ASCII default, dirty-worktree stance,
//! git safety, and comment hygiene. Git safety rules previously lived in
//! [`super::dev_loop_workflow`] invariants; this section is the single source
//! of truth.
