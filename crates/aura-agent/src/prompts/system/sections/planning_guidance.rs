...
//!
//! Codex-derived plan-tool guidance plus aura's `submit_plan` contract.
//! Dev-loop path only — chat carries its own planning flow in
//! [`super::super::CHAT_SYSTEM_PROMPT_BASE`].
