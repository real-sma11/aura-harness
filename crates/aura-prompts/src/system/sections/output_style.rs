...
//!
//! Codex-derived final-answer formatting rules adapted for aura.
//! Applies to both dev-loop and chat paths so assistant text and
//! `task_done` `notes` stay scannable.
